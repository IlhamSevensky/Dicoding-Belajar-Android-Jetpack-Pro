    ...
    fun generateDataMovieDummy(): List<MovieEntity> {
        ...
        listMovie.add(
            MovieEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/xcaSYLBhmDzJ6P14bcKe0KTh3QV.jpg",
                isFavorite = false
            )
        )
        ...
        listMovie.add(
            MovieEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/XAvFHWmWjBeJUQEHBbCcXvzdDZ.jpg",
                isFavorite = false
            )
        )
        ...
        listMovie.add(
            MovieEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/7568G5PAdQweNfTiuwzlssOxueB.jpg",
                isFavorite = false
            )
        )
        ...
        listMovie.add(
            MovieEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/heyvaoVLGC8lcB4FFoz65EBI8xF.jpg",
                isFavorite = false
            )
        )
        ...
        listMovie.add(
            MovieEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/ngBFDOsx13sFXiMweDoL54XYknR.jpg",
                isFavorite = false
            )
        )
        ...
        listMovie.add(
            MovieEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/h3KN24PrOheHVYs9ypuOIdFBEpX.jpg",
                isFavorite = false
            )
        )
        ...
        listMovie.add(
            MovieEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/kbGO5mHPK7rh516MgAIJUQ9RvqD.jpg",
                isFavorite = false
            )
        )
    ...
    fun generateDataTvShowDummy(): List<TvShowEntity> {
        ...
        listTvShow.add(
            TvShowEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/fANxNeH9JCXPrzNEfriGu1Y95dF.jpg",
                isFavorite = false
            )
        )
        ...
        listTvShow.add(
            TvShowEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/hnK5vODlS1OIIF3Sw6T0RQyt0K3.jpg",
                isFavorite = false
            )
        )
        ...
        listTvShow.add(
            TvShowEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/rkRqvadAVWzdnrS6bdcUAyJtfpy.jpg",
                isFavorite = false
            )
        )
        ...
        listTvShow.add(
            TvShowEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/xM8zPWNqwbgCZQNgOOH2YeM7Cu.jpg",
                isFavorite = false
            )
        )
        ...
        listTvShow.add(
            TvShowEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/l0U4mNs2vp65AAbfH8v2ymij8T5.jpg",
                isFavorite = false
            )
        )
        ...
        listTvShow.add(
            TvShowEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/ym20NYY99jNH0OzSg4TgLLGsQF9.jpg",
                isFavorite = false
            )
        )
        ...
        listTvShow.add(
            TvShowEntity(
                ...
                imgPreview = "https://image.tmdb.org/t/p/original/ofjZbud67zO2wxQ48VgMVnkECQu.jpg",
                isFavorite = false
            )
        )
